...
const ANSWERS: Record<string, string> = {
  ...
  "What is the APC?":
    "IJLSCL charges a nominal Article Processing Charge to support open-access publication. See the APC page for current rates and waivers.",
  "How long is peer review?":
  ...
  "How can I verify a certificate?":
    "Use the Verify page and enter the certificate ID (format: IJLSCL-YYYY-####).",
};
