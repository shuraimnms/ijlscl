...
> = {
  latest: {
    ...
    intro:
      "The newest research from IJLSCL — original studies, reviews, and conceptual pieces, freshly indexed and open to read.",
  ...
  "most-viewed": {
    ...
    intro:
      "The most-read IJLSCL articles across all issues — a live snapshot of what's driving conversation in commerce and management research.",
    crumb: "Most Viewed",
    empty:
  ...
  "most-cited": {
    ...
    intro:
      "IJLSCL articles that have accumulated the most citations across Crossref, Scholar, and partner databases.",
    crumb: "Most Cited",
    empty:
