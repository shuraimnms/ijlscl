...
export const Route = createFileRoute("/associate-editors")({
  head: () => ({
    meta: [
      { title: "Associate Editors — IJLSCL" },
      { name: "description", content: "Meet the subject editors who handle submissions across finance, marketing, HR, operations, and strategy at IJLSCL." },
      { property: "og:title", content: "Associate Editors — IJLSCL" },
      { property: "og:description", content: "IJLSCL's subject-specialist editorial team." },
    ],
