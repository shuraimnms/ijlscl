  ...
  head: () => ({
    meta: [
      { title: "Publication Process — IJLSCL" },
      {
        name: "description",
        content:
          "The end-to-end IJLSCL publication journey: submission, editorial screening, double-blind review, decision, production, DOI registration, and post-publication support.",
      },
