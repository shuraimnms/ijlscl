...
const JOURNAL_DETAILS: [string, string][] = [
  ["Full Title", "International Journal of Legal Studies and Contemporary Law"],
  ["Abbreviation", "IJLSCL"],
  ["Print ISSN", "2455-0116"],
  ["Online ISSN", "2395-6410"],
  ...
  ["Website", "ijlscl.com"],
  ["Editorial Email", "editor@ijlscl.com"],
];
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        title="International Journal of Legal Studies and Contemporary Law"
      ...
      <div className="container-page py-12">
        ...
        <CtaStrip
          ...
          title="Submit your manuscript to IJLSCL"
