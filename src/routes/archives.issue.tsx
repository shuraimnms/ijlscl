...
export const Route = createFileRoute("/archives/issue")({
  head: () => ({
    meta: [
      { title: "Archives by Issue — IJLSCL" },
      { name: "description", content: "Browse IJLSCL archives by issue." },
      { property: "og:title", content: "Archives by Issue — IJLSCL" },
      { property: "og:description", content: "Browse IJLSCL archives by issue." },
    ],
