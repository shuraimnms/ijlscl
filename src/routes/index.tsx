...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "IJLSCL — International Journal of Legal Studies and Contemporary Law",
      },
      {
    ...
    <SiteLayout>
      ...
      <section className="relative w-full min-h-[100svh] md:min-h-[600px] lg:min-h-[700px] overflow-hidden bg-[#0f172a]">
        ...
        <Link
          ...
          className="hidden md:flex absolute right-0 top-[20%] z-30 bg-[#475569] text-white py-4 px-2 rounded-l-md font-bold text-sm tracking-widest writing-mode-vertical hover:bg-[#334155] transition-colors shadow-lg"
            ...
            <div className="space-y-4 max-w-[320px]">
              <div className="flex items-center gap-4">
                <div className="w-6 flex justify-center">
                  <Stamp className="h-5 w-5 text-[#94a3b8]" />
                </div>
              ...
              <div className="flex items-center gap-4">
                <div className="w-6 flex justify-center">
                  <Zap className="h-5 w-5 text-[#94a3b8]" />
                </div>
                <span className="text-white font-medium text-sm tracking-wider uppercase whitespace-nowrap">
                  JUSTICE
                </span>
      ...
      <div className="relative bg-[#f8fafc] py-6 border-b-4 border-[#94a3b8]">
        ...
        <div className="container-page relative z-10 flex flex-wrap items-center justify-center gap-6 md:justify-between px-4 lg:px-12 py-6 md:py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="font-serif font-bold text-[#0f172a] tracking-wide">
              CONTEMPORARY LAW
            </span>
          </div>
          ...
          <div className="grid items-center gap-8 md:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)]">
            <div className="text-white">
              ...
              <p className="mt-3 max-w-xl text-sm md:text-[15px] text-white/80">
                Original, unpublished research in legal studies, contemporary law and allied
                disciplines is invited. Fast-track peer review, DOI on acceptance, and open access
                indexing.
              </p>
