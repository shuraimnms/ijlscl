  ...
  return (
    <SiteLayout>
      ...
      <section className="relative w-full min-h-[100svh] md:min-h-[600px] lg:min-h-[700px] overflow-hidden bg-[#0f172a]">
        ...
        <Link to="/conferences/call-for-papers" className="hidden md:flex absolute right-0 top-[20%] z-30 bg-[#475569] text-white py-4 px-2 rounded-l-md font-bold text-sm tracking-widest writing-mode-vertical hover:bg-[#334155] transition-colors shadow-lg" style={{ writingMode: 'vertical-rl', transform: 'rotate(180deg)' }}>
          CALL FOR PAPERS
        </Link>
        ...
        <div className="relative z-10 container-page h-full flex items-center">
          <div className="w-full max-w-[650px] bg-transparent px-4 py-24 sm:px-6 md:py-10 md:px-10 md:pt-16 relative z-10">
            ...
            <h1 className="font-serif text-[32px] sm:text-4xl md:text-5xl lg:text-[56px] leading-[1.25] md:leading-[1.15] font-bold text-white mb-6 drop-shadow-lg">
              ...
              <span className="text-[#94a3b8]">Legal Studies and Contemporary Law</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              <Link
                to="/current-issue"
                className="bg-[#94a3b8] hover:brightness-110 text-[#0f172a] font-bold text-[15px] px-8 py-3.5 rounded-full transition-all shadow-[0_4px_14px_0_rgba(0,0,0,0.3)] hover:shadow-[0_6px_20px_rgba(255,255,255,0.15)] hover:-translate-y-0.5"
              >
                Explore Research
              </Link>
              <Link
                to="/submit"
                className="bg-transparent border-2 border-[#94a3b8] text-[#94a3b8] hover:bg-[#94a3b8]/10 font-bold text-[15px] px-8 py-3.5 rounded-full transition-all hover:-translate-y-0.5"
              >
                Submit Manuscript
              </Link>
            </div>
            ...
            <div className="space-y-4 max-w-[320px]">
              <div className="flex items-center gap-4">
                ...
                <span className="text-white font-medium text-sm tracking-wider uppercase whitespace-nowrap">LEGAL</span>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-white font-medium text-sm tracking-wider uppercase whitespace-nowrap">CONTEMPORARY</span>
                <div className="flex-1 flex items-center">
                  <div className="h-[1px] bg-white/20 flex-1"></div>
                  <div className="w-1.5 h-1.5 rounded-full bg-[#94a3b8]"></div>
                </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-white font-medium text-sm tracking-wider uppercase whitespace-nowrap">JUSTICE</span>
                <div className="flex-1 flex items-center">
                  <div className="h-[1px] bg-white/20 flex-1"></div>
                  <div className="w-1.5 h-1.5 rounded-full bg-[#94a3b8]"></div>
                </div>
              ...
              <div className="grid gap-6 md:grid-cols-4">
                ...
                <InfoBlock title="CALL FOR PAPERS">
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    IJLSCL invites original and unpublished research papers for upcoming issues.
                  </p>
                  <Link
                ...
                {/* Why publish */}
                <InfoBlock title="WHY PUBLISH WITH IJLSCL?">
                  <ul className="space-y-1.5 text-sm">
                    {WHY_POINTS.map((p) => (
          ...
          <div className="grid items-center gap-8 md:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)]">
            <div className="text-white">
              ...
              <p className="mt-3 max-w-xl text-sm md:text-[15px] text-white/80">
                Original, unpublished research in legal studies, contemporary law and allied disciplines is
        ...
        <div className="container-page py-16 lg:py-20">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {[
              ...
              {
                quote:
                  "Transparent editorial communication and a clean production process. IJLSCL is now my first choice.",
