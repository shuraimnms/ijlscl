  ...
  head: () => ({
    meta: [
      { title: "Contact — IJLSCL" },
      {
        name: "description",
        content:
          "Contact the IJLSCL editorial office for submissions, editorial enquiries, reviewer registration, ethics complaints, and technical support.",
      },
          ...
          <div>
            ...
            >
              ...
              <label className="flex items-start gap-2 text-xs text-muted-foreground">
                ...
                <span>
                  I consent to IJLSCL storing the information above solely to respond to my enquiry.
                </span>
              </label>
              <button
                disabled={busy}
