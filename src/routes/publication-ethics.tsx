...
export const Route = createFileRoute("/publication-ethics")({
  head: () => ({
    meta: [
      { title: "Publication Ethics & Malpractice Statement — IJLSCL" },
      { name: "description", content: "IJLSCL follows COPE guidelines for authorship, peer review, conflicts of interest, plagiarism, corrections, and retractions." },
      { property: "og:title", content: "Publication Ethics — IJLSCL" },
...
const FAQS = [
  ...
  { q: "Are generative AI tools allowed in manuscripts?", a: "Authors may use generative AI for language polishing but must disclose its use. AI cannot be listed as an author and cannot produce novel legal or scholarly claims without human verification." },
];
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="IJLSCL follows the Committee on Publication Ethics (COPE) Core Practices. Everyone in our workflow — authors, reviewers, editors — is bound by these standards."
      />
      <div className="container-page py-12">
        ...
        <CtaStrip
          ...
          intro="If you suspect ethical breach, plagiarism, or misconduct in any IJLSCL article, please write to the Editor-in-Chief. We investigate every credible allegation."
          actions={[
