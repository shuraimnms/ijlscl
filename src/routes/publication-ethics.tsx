  ...
  head: () => ({
    meta: [
      { title: "Publication Ethics & Malpractice Statement — IJLSCL" },
      {
        name: "description",
        content:
          "IJLSCL follows COPE guidelines for authorship, peer review, conflicts of interest, plagiarism, corrections, and retractions.",
      },
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Authors may use generative AI for language polishing but must disclose its use. AI cannot be listed as an author and cannot produce novel legal or scholarly claims without human verification.",
  },
];
