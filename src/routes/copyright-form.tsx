...
function CopyrightForm() {
  ...
  const generatePDF = () => {
    ...
    if (!w) return;
    w.document.write(`<html><head><title>IJLSCL Copyright Form — ${state.manuscriptTitle}</title>
...
<h1>International Journal of Legal Studies and Contemporary Law</h1>
...
<p>The undersigned assigns to IJLSCL first-publication rights and the non-exclusive right to distribute the article under CC BY-NC 4.0, while retaining copyright.</p>
<h2>Signature</h2>
