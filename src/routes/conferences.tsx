...
export const Route = createFileRoute("/conferences")({
  head: () => ({
    meta: [
      { title: "Conferences — IJLSCL" },
      { name: "description", content: "IJLSCL-affiliated conferences, symposia, and workshops." },
    ],
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="Academic events organised or co-hosted by IJLSCL."
      />
