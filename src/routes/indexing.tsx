  ...
  head: () => ({
    meta: [
      { title: "Abstracting & Indexing — IJLSCL" },
      {
        name: "description",
        content:
          "IJLSCL is discoverable through global indexing and abstracting services, DOI registration via Crossref, and open-access directories.",
      },
      { property: "og:title", content: "Abstracting & Indexing — IJLSCL" },
      {
        property: "og:description",
        content: "Discovery services, DOI registration, and indexing partners for IJLSCL.",
      },
    ],
...
const SERVICES: Service[] = [
  ...
  },
  {
    ...
    category: "Discovery",
    icon: Search,
    body: "IJLSCL articles are structured with Highwire / Dublin Core meta tags for automatic Google Scholar harvesting and citation tracking.",
    to: "/google-scholar",
  },
  {
    ...
    category: "Directory",
    icon: BookMarked,
    body: "Application filed with the Directory of Open Access Journals. IJLSCL already meets DOAJ's transparency, peer-review, and open-access criteria while the review is in progress.",
  },
  {
...
const FAQS = [
  {
    q: "How can I confirm a specific IJLSCL article is indexed?",
          ...
          <div className="flex flex-wrap items-end justify-between gap-3">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-muted-foreground">
                ...
                make IJLSCL content discoverable to researchers, librarians, and funders worldwide.
              </p>
            </div>
          ...
          <div className="relative overflow-hidden rounded-2xl border border-brand/30 bg-gradient-to-br from-brand-muted/60 to-background p-8">
            ...
            <div className="relative">
              ...
              <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
                IJLSCL is a Crossref member. On final publication, each article is minted a DOI in
                the form
                <code className="mx-1 rounded bg-secondary px-1.5 py-0.5 text-xs">
                  10.xxxxx/ijlscl.v{"{"}vol{"}"}.i{"{"}iss{"}"}.###
                </code>
