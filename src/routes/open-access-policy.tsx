  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="IJLSCL provides open access to its published content with the objective of promoting wider dissemination and exchange of academic knowledge."
      />
      <div className="container-page py-12">
        ...
        <section className="mt-12 grid gap-6 lg:grid-cols-2">
          <article className="rounded-2xl border border-border bg-card p-6 lg:p-8">
            ...
            <p className="mt-3 text-sm text-muted-foreground">Readers using IJLSCL content must:</p>
