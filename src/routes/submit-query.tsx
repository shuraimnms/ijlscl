...
export const Route = createFileRoute("/submit-query")({
  head: () => ({
    meta: [
      { title: "Submit a Query — IJLSCL" },
      { name: "description", content: "Send a structured query to the IJLSCL editorial or technical team and get a reply within two working days." },
      { property: "og:title", content: "Submit a Query — IJLSCL" },
...
function SubmitQuery() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      toast.error("Something went wrong. Please email editorial@ijlscl.com directly.");
    } finally {
      setLoading(false);
    }
  }
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_320px]">
          <form onSubmit={onSubmit} className="rounded-2xl border border-border bg-card p-6 lg:p-8">
            ...
            <div className="mt-6 grid gap-5 sm:grid-cols-2">
              ...
              <Field label="Submission ID (if any)" name="submission_id" placeholder="IJLSCL-2026-0123" />
              <div className="sm:col-span-2">
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-2xl border border-border bg-card p-6">
              ...
              <p className="mt-4 text-sm text-muted-foreground">
                Editorial: <a href="mailto:editorial@ijlscl.com" className="text-brand hover:underline">editorial@ijlscl.com</a>
                <br />
                Support: <a href="mailto:support@ijlscl.com" className="text-brand hover:underline">support@ijlscl.com</a>
              </p>
            </div>
          </aside>
        </div>
