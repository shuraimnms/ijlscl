  ...
  head: () => ({
    meta: [
      { title: "Submit a Query — IJLSCL" },
      {
        name: "description",
        content:
          "Send a structured query to the IJLSCL editorial or technical team and get a reply within two working days.",
      },
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-2xl border border-border bg-card p-6">
              ...
              <p className="mt-4 text-sm text-muted-foreground">
                Editorial:{" "}
                <a href="mailto:editorial@ijlscl.com" className="text-brand hover:underline">
                  editorial@ijlscl.com
                </a>
                <br />
                Support:{" "}
                <a href="mailto:support@ijlscl.com" className="text-brand hover:underline">
                  support@ijlscl.com
                </a>
              </p>
            </div>
