...
export const Route = createFileRoute("/ebooks")({
  head: () => ({
    meta: [{ title: "E-Books — IJLSCL" }, { name: "description", content: "Open-access e-books curated by IJLSCL." }],
...
function Ebooks() {
  ...
  return (
    <SiteLayout>
      <PageHero eyebrow="Library" title="E-Books" intro="Curated open-access volumes drawn from IJLSCL research." />
