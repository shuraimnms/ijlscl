...
export const Route = createFileRoute("/editorial-board")({
  head: () => ({
    meta: [
      { title: "Editorial Board — IJLSCL" },
      { name: "description", content: "Editors, advisory board members, and peer reviewers of IJLSCL." },
    ],
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="Researchers and legal practitioners who guide, review, and safeguard the scholarly and legal integrity of IJLSCL."
      />
