...
export const Route = createFileRoute("/verify")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Verify the authenticity of any IJLSCL certificate by its tracking number.",
      },
      { property: "og:title", content: "Verify a Certificate — IJLSCL" },
      {
        property: "og:description",
        content: "Verify IJLSCL publication, reviewer, and conference certificates.",
      },
    ],
