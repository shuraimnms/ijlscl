  ...
  head: () => ({
    meta: [
      { title: "Editorial Office — IJLSCL" },
      {
        name: "description",
        content:
          "Contact details, working hours, and remit of the IJLSCL editorial office — the operational heart of the journal.",
      },
...
const CHANNELS = [
  {
    ...
    value: "editorial@ijlscl.com",
    href: "mailto:editorial@ijlscl.com",
  },
  {
    icon: Mail,
    label: "Technical support",
    value: "support@ijlscl.com",
    href: "mailto:support@ijlscl.com",
  },
  {
    icon: Phone,
  ...
  },
  {
    ...
    value: "IJLSCL Editorial Office, Registered Address (to be published).",
    href: "#",
  },
];
...
const FAQS = [
  ...
  },
  {
    ...
    a: "IJLSCL operates a distributed editorial team. All correspondence is handled by email; in-person meetings are by scheduled appointment at conferences.",
  },
  {
    q: "Whom should I contact about DOIs or metadata corrections?",
    a: "Email editorial@ijlscl.com with your article DOI and the correction requested. Metadata is re-deposited with Crossref within five working days.",
  },
];
