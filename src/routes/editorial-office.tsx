...
export const Route = createFileRoute("/editorial-office")({
  head: () => ({
    meta: [
      { title: "Editorial Office — IJLSCL" },
      { name: "description", content: "Contact details, working hours, and remit of the IJLSCL editorial office — the operational heart of the journal." },
      { property: "og:title", content: "Editorial Office — IJLSCL" },
      { property: "og:description", content: "How to reach the IJLSCL editorial office." },
    ],
...
const CHANNELS = [
  { icon: Mail, label: "Editorial email", value: "editorial@ijlscl.com", href: "mailto:editorial@ijlscl.com" },
  { icon: Mail, label: "Technical support", value: "support@ijlscl.com", href: "mailto:support@ijlscl.com" },
  { icon: Phone, label: "Phone (office hours)", value: "+91 000 000 0000", href: "tel:+910000000000" },
  { icon: MapPin, label: "Correspondence", value: "IJLSCL Editorial Office, Registered Address (to be published).", href: "#" },
];
...
const FAQS = [
  ...
  { q: "Can I visit the editorial office?", a: "IJLSCL operates a distributed editorial team. All correspondence is handled by email; in-person meetings are by scheduled appointment at conferences." },
  { q: "Whom should I contact about DOIs or metadata corrections?", a: "Email editorial@ijlscl.com with your article DOI and the correction requested. Metadata is re-deposited with Crossref within five working days." },
];
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="The IJLSCL editorial office is the operational heart of the journal — coordinating peer review, ethics, production, and post-publication support."
      />
