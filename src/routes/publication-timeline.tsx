  ...
  head: () => ({
    meta: [
      { title: "Publication Frequency — IJLSCL" },
      {
        name: "description",
        content:
          "IJLSCL publishes four regular quarterly issues every year — March, June, September, and December — with occasional special and theme-based issues.",
      },
      { property: "og:title", content: "Publication Frequency — IJLSCL" },
      {
        property: "og:description",
        content: "Quarterly publication schedule and special-issue policy of IJLSCL.",
      },
    ],
