...
export const Route = createFileRoute("/advisory-board")({
  head: () => ({
    meta: [
      { title: "International Advisory Board — IJLSCL" },
      { name: "description", content: "Senior scholars and practitioners advising IJLSCL on strategic direction, ethics, and long-term editorial policy." },
      { property: "og:title", content: "Advisory Board — IJLSCL" },
      { property: "og:description", content: "Strategic advisors to IJLSCL." },
    ],
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="Distinguished scholars and practitioners who shape IJLSCL's long-term direction, ethics posture, and international presence."
      />
      <div className="container-page py-12">
        ...
        <CtaStrip
          ...
          title="Full transparency about how IJLSCL is run"
