...
// Nav structure mirrors the IJLSCL policy document's site map.
...
export const JOURNAL = {
  ...
  address: "Editorial Office, IJLSCL, India",
} as const;
...
export const NAV: NavGroup[] = [
...

  {
    ...
    items: [
      ...
      { label: "Vision", to: "/vision-mission", description: "Long-term vision of IJLSCL." },
...

  {
    ...
    items: [
      ...
      { label: "Constitutional Law", to: "/aims-scope", description: "Constitutional law and rights." },
      { label: "Criminal Law", to: "/aims-scope", description: "Criminal law and justice." },
      { label: "Corporate Law", to: "/aims-scope", description: "Corporate and commercial law." },
      { label: "Cyber Law", to: "/aims-scope", description: "Cyber law and data privacy." },
      { label: "International Law", to: "/aims-scope", description: "Public and private international law." },
      { label: "Human Rights", to: "/aims-scope", description: "Human rights and liberties." },
...

  {
    ...
    items: [
      ...
      { label: "Case Studies", to: "/articles", description: "Case studies published in IJLSCL." },
...

  {
    ...
    items: [
      ...
      { label: "Publication", to: "/publication-process", description: "Final publication in IJLSCL." },
    ],
  },
